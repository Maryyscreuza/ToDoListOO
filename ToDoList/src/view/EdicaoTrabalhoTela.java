...
public class EdicaoTrabalhoTela extends JFrame {

	public EdicaoTrabalhoTela() {
		...
		/*
		 * JButton jbtSalvar = new JButton("Salvar"); jbtSalvar.setForeground(new
		 * Color(255, 255, 255)); jbtSalvar.setBackground(new Color(0, 0, 121));
		 * jbtSalvar.setBounds(215, 195, 130, 40); jbtSalvar.addActionListener(new
		 * ActionListener() { public void actionPerformed(ActionEvent e) {
		 * if(e.getSource() == jbtSalvar) { edit(i, k); } } }); c.add(jbtSalvar);
		 */
