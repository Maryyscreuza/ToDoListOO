...
lista.cadastrarPessoal(listaPessoal);lista.cadastrarEducação(listaEducação);lista.cadastrarTrabalho(listaTrabalho);
 ...
 * figurinhaFWC.getCodigo() + " " + albumFigurinha.getFigurinhaFWC() +
 * ", no Album " + proprietario1.getAlbumFigurinha());
 */
